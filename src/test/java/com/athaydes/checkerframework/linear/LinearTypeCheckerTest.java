...
public class LinearTypeCheckerTest {
    ...
    private OsgiaasJavaCompiler compiler = new OsgiaasJavaCompiler(DefaultClassLoaderContext.INSTANCE,
            asList("-processor", "com.athaydes.checker.linear.LinearChecker", "-AprintErrorStack"));


    @Test
    public void canAssignLiteralToLinearVariable() throws IllegalAccessException, InstantiationException {
        Optional<Class<Object>> runner = compiler.compile("Runner", "import com.athaydes.checker.linear.qual.Linear;\n" +
    ...
    @Test
    public void canAssignNewObjectToLinearVariable() throws IllegalAccessException, InstantiationException {
        Optional<Class<Object>> runner = compiler.compile("Runner", "import com.athaydes.checker.linear.qual.Linear;\n" +
                "public class Runner implements Runnable {\n" +
                "  public void run() {\n" +
    ...
    public void cannotUseLinearVariableAfterUsedUp() {
        ...
        Optional<Class<Object>> compiledClass = compiler.compile("Runner", "import com.athaydes.checker.linear.qual.Linear;\n" +
                "public class Runner implements Runnable {\n" +
                "  public void run() {\n" +
                "    @Linear String s = \"hello @Linear\";\n" +
